    ...
    .insert([
      {
        ...
        reference_number:       `KX-PHARMA-${orgId.slice(0, 8)}-001`,
      ...
      },
      {
        ...
        reference_number:       `KX-AGRO-${orgId.slice(0, 8)}-001`,
      ...
      },
      {
        ...
        reference_number:       `KX-ELECT-${orgId.slice(0, 8)}-001`,
      ...
      },
      {
        ...
        reference_number:       `KX-PEST-${orgId.slice(0, 8)}-001`,
        manufacturer_id:        mfr2?.id ?? null,
      ...
      },
      {
        ...
        reference_number:       `KX-PETRO-${orgId.slice(0, 8)}-001`,
        manufacturer_id:        null,
