    ...
    .insert([
      {
        ...
        vessel_name:            'MSC ANZU',
        bl_number:              'MSCU3847621900',
        hs_code:                '3004.20',
      ...
      },
      {
        ...
        vessel_name:            'CMA CGM SAMBHAR',
        bl_number:              'CMDUIND4572301',
        hs_code:                '3105.20',
      ...
      },
      {
        ...
        destination_port:       'Mombasa',
        origin_country:         'China',
        vessel_name:            'COSCO SHIPPING CAPRICORN',
        bl_number:              'COSU6278903410',
        hs_code:                '9405.40',
      ...
      },
      {
        ...
        destination_port:       'Mombasa',
        origin_country:         'India',
        vessel_name:            'PIL NEPTUNE',
        bl_number:              'PILSIN7634820B1',
        hs_code:                '3808.91',
      ...
      },
      {
        ...
        destination_port:       'Mombasa',
        origin_country:         'UAE',
        vessel_name:            'CHEM PHOENIX',
        bl_number:              'CHPXDXB2026047A',
        hs_code:                '2710.19.11',
  ...
  if (s0) {
    await supabase.from('actions').insert([
      ...
      },
      {
        ...
        description: 'Confirm IDF lodged on KRA iCMS by clearing agent. Check packing list matches BoL quantities exactly.',
  ...
  if (s4) {
    await supabase.from('actions').insert([
      ...
      },
      {
        ...
        description: 'Jet A-1 (HS 2710.19.11) attracts 0% import duty. Ensure HS code is correctly declared on customs entry to avoid KES 19.9M misclassification penalty. Your clearing agent files on KRA iCMS.',
        source: 'SYSTEM', status: 'IN_PROGRESS',
      },
      {
        organization_id: orgId, shipment_id: s4.id,
